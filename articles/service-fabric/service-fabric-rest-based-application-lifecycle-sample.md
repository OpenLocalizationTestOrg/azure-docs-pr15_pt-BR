<properties
   pageTitle="Exemplo de ciclo de vida do aplicativo baseado em REST | Microsoft Azure"
   description="Um exemplo de estrutura de serviço do Microsoft Azure que mostra o ciclo de vida do aplicativo usando a interface de serviço tecidos restante."
...
# <a name="rest-based-application-lifecycle-sample"></a>Exemplo de ciclo de vida do aplicativo baseado em REST

Este exemplo demonstra o ciclo de vida do aplicativo de serviço tecidos por meio de chamadas de API REST. Para obter mais informações sobre o ciclo de vida do aplicativo de serviço tecidos, consulte [ciclo de vida de aplicativo de serviço tecidos](service-fabric-application-lifecycle.md).

Este exemplo executa o seguinte:

* Disposições de repositório de amostra **WordCount 1.0.0** do pacote de aplicativo WordCount na imagem.
* Exibe a lista dos tipos de aplicativos, que inclui WordCount 1.0.0.
* Cria o aplicativo WordCount como **tecidos: / WordCount**.
* Exibe a lista de aplicativos, que inclui tecidos: / WordCount versão 1.0.0.
* Versão de disposições a 1.1.0 da amostra WordCount do pacote de aplicativo **WordCountUpgrade** na loja de imagem.
* Exibe a lista dos tipos de aplicativos, que inclui WordCount 1.0.0 e **WordCount 1.1.0**.
* Atualiza o aplicativo WordCount versão 1.1.0.
* Exibe a lista de aplicativos, que inclui WordCount versão 1.1.0, mas não inclui mais WordCount versão 1.0.0.
* Exclui o aplicativo WordCount.
* Exibe a lista de aplicativos, que não inclui mais tecidos: / WordCount.
* Versão de unprovisions o 1.1.0 da amostra WordCount.
* Exibe a lista dos tipos de aplicativos, que inclui WordCount 1.0.0, mas não inclui mais WordCount 1.1.0.
* Versão de unprovisions o 1.0.0 da amostra WordCount.
* Exibe a lista dos tipos de aplicativos, que não inclui mais WordCount.


## <a name="prerequisites"></a>Pré-requisitos

Este exemplo utiliza a [amostra de WordCount](http://aka.ms/servicefabricsamples) (encontrado nos exemplos **Introdução** ). A amostra de WordCount deve ser compilada primeiro e, em seguida, dois pacotes de aplicativo devem ser copiados para o armazenamento de imagens.

|Pasta|Descrição|
|------|-----------|
|WordCount|O aplicativo de amostra WordCount. O arquivo **ApplicationManifest.xml** contém **ApplicationTypeVersion = "1.0.0"**.|
|WordCountUpgrade|O aplicativo de amostra WordCount. O arquivo de ApplicationManifest.xml deve ser alterado para **ApplicationTypeVersion = "1.1.0"** para permitir que a atualização do aplicativo ocorra.|

Para criar os pacotes de aplicativo e copiá-los para o repositório de imagem, siga estes passos:

1. Copie **C:\ServiceFabricSamples\Services\WordCount\WordCount\pkg\Debug** para **C:\Temp\WordCount**. Isso cria o pacote de aplicativo WordCount.
2. Copie C:\Temp\WordCount para **C:\Temp\WordCountUpgrade**. Isso cria o pacote de **aplicativo de WordCountUpgrade** .
...
5. Salve o arquivo de ApplicationManifest.xml foi alterado.
6. Execute o seguinte script do PowerShell como administrador para copiar os aplicativos para o repositório de imagem:
...
Quando termina o script do PowerShell, este aplicativo está pronto para executar.

## <a name="example"></a>Exemplo

O exemplo a seguir demonstra o ciclo de vida do aplicativo de serviço tecidos.
