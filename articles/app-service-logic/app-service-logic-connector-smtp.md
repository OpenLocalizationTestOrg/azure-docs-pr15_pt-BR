<properties
   pageTitle="Utilizando o conector de SMTP nos aplicativos de lógica | Serviço de aplicativo do Microsoft Azure"
   description="Como criar e configurar o aplicativo de conector SMTP ou API e usá-lo em um aplicativo de lógica no serviço de aplicativo do Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-smtp-connector"></a>Melhoramos o conector SMTP 
...
- [Saiba mais sobre esse novo conector](../connectors/connectors-create-api-smtp.md)
