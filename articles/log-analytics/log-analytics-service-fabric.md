...
![Registros de conta de armazenamento](./media/log-analytics-service-fabric/sf1.png)
...
![Bloco de estrutura de serviço](./media/log-analytics-service-fabric/sf2.png)
