<properties 
   ...
   description="Aprenda a controlar o roteamento e usar dispositivos virtuais no Gerenciador de recursos do Azure usando um modelo"
...
#<a name="create-user-defined-routes-udr-in-resource-manager-by-using-a-template"></a>Criar rotas de definidas pelo usuário (UDR) no Gerenciador de recursos usando um modelo

[AZURE.INCLUDE [virtual-network-create-udr-arm-selectors-include.md](../../includes/virtual-network-create-udr-arm-selectors-include.md)]

[AZURE.INCLUDE [virtual-network-create-udr-intro-include.md](../../includes/virtual-network-create-udr-intro-include.md)]

[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]Este artigo discute o modelo de implantação do Gerenciador de recursos. 

[AZURE.INCLUDE [virtual-network-create-udr-scenario-include.md](../../includes/virtual-network-create-udr-scenario-include.md)]

## <a name="udr-resources-in-a-template-file"></a>Recursos UDR em um arquivo de modelo

Você pode ver e baixar o [modelo de exemplo](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR).

A seção a seguir mostra a definição do front-end UDR no arquivo **azuredeploy-vnet-nsg-udr.json** , baseado no cenário acima.
...
Para associar o UDR à sub-rede front-end, você precisa alterar a definição de sub-rede no modelo e usar a id de referência para o UDR.
...
Você também precisa garantir que a máquina virtual **FW1** tenha a propriedade ativada no NIC que será usado para receber e encaminhar pacotes de encaminhamento de IP. A seção a seguir mostra a definição da NIC para FW1 no arquivo azuredeploy-nsg-udr.json, baseado no cenário acima.
...
3. Executar o `New-AzureRmResourceGroupDeployment` cmdlet para implantar o modelo.
...
3. Em seu navegador, navegue até **https://raw.githubusercontent.com/telmosampaio/azure-templates/master/IaaS-NSG-UDR/azuredeploy.parameters.json**, copie o conteúdo do arquivo json e colar em um novo arquivo em seu computador. Para esse cenário, você poderia ser copiando os valores abaixo em um arquivo denominado **c:\udr\azuredeploy.parameters.json**.
...
4. Execute o cmdlet **Criar grupo azure** para implantar o novo VNet usando os arquivos de modelo e um parâmetro que você baixou e modificado acima. A lista mostrada após a saída explica os parâmetros usados.
...
5. Execute o comando **Mostrar grupo azure** para exibir os recursos criados no novo grupo de recursos. 
...
>[AZURE.TIP] Se você não vir todos os recursos, execute o `azure group deployment show` comando para garantir que o estado de provisionamento de implantação é *Succeded*.