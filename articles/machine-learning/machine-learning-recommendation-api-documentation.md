...
#<a name="azure-machine-learning-recommendations-api-documentation"></a>Azure Machine Learning Recommendations API Documentation
...
##<a name="3-apis---general-information"></a>3. APIs - general information
...
###<a name="34-ids-are-case-sensitive"></a>3.4. IDs are case sensitive
...
##<a name="4-recommendations-quality-and-cold-items"></a>4. Recommendations Quality and Cold Items

###<a name="41-recommendation-quality"></a>4.1. Recommendation quality
...
###<a name="43-recommendation-reasoning"></a>4.3. Recommendation reasoning
...
###<a name="51-create-model"></a>5.1. Create Model
...
###<a name="52-get-model"></a>5.2. Get Model
...
###<a name="53-get-all-models"></a>5.3. Get All Models
...
###<a name="54-update-model"></a>5.4. Update Model
...
###<a name="55-delete-model"></a>5.5. Delete Model
...
##<a name="6-model-advanced"></a>6. Model Advanced

###<a name="61-model-data-insight"></a>6.1. Model Data Insight
...
###<a name="63-get-model-sample"></a>6.3. Get Model Sample
...
##<a name="7-model-business-rules"></a>7. Model Business Rules
...
###<a name="71-get-model-rules"></a>7.1. Get Model Rules
...
###<a name="72-add-rule"></a>7.2. Add Rule
...
<br>
`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>FeatureWhiteList</Type><Value>{"Name":"Movie_rating","Values":["PG13"]}</Value></ApiFilter>`<br><br><ins> To add a PerSeedBlockList rule:</ins><br>`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>PerSeedBlockList</Type><Value>{"SeedItems":["9949"],"ItemsToExclude":["9862","8158","8244"]}</Value></ApiFilter>`|
...
###<a name="73-delete-rule"></a>7.3. Delete Rule
...
###<a name="74-delete-all-rules"></a>7.4. Delete All Rules
...
##<a name="8-catalog"></a>8. Catalog

###<a name="81-import-catalog-data"></a>8.1. Import Catalog Data
...
###<a name="82-get-catalog"></a>8.2. Get Catalog
...
###<a name="83-get-catalog-items-by-token"></a>8.3. Get Catalog Items by Token
...
##<a name="9-usage-data"></a>9. Usage data
###<a name="91-import-usage-data"></a>9.1. Import Usage Data
####<a name="911-uploading-file"></a>9.1.1. Uploading File
...
####<a name="912-using-data-acquisition"></a>9.1.2. Using Data Acquisition
...
###<a name="92-list-model-usage-files"></a>9.2. List Model Usage Files
...
###<a name="93-get-usage-statistics"></a>9.3. Get Usage Statistics
...
###<a name="94-get-usage-file-sample"></a>9.4. Get Usage File Sample
...
###<a name="95-get-model-usage-file"></a>9.5. Get Model Usage File
...
###<a name="96-delete-usage-file"></a>9.6. Delete Usage File
...
###<a name="97-delete-all-usage-files"></a>9.7. Delete All Usage Files
...
##<a name="10-features"></a>10. Features
...
###<a name="101-get-features-info-for-last-rank-build"></a>10.1. Get Features Info (For Last Rank Build)
...
###<a name="102-get-features-info-for-specific-rank-build"></a>10.2. Get Features Info (For Specific Rank Build)
...
####<a name="111-build-parameters"></a>11.1 Build parameters
...
#####<a name="1111-usage-condenser"></a>11.1.1. Usage condenser
...
#####<a name="1112-rank-build-parameters"></a>11.1.2. Rank build parameters
...
#####<a name="1113-recommendation-build-parameters"></a>11.1.3. Recommendation build parameters
...
###<a name="112-trigger-a-recommendation-build"></a>11.2. Trigger a Recommendation Build
...
###<a name="113-trigger-build-recommendation-rank-or-fbt"></a>11.3. Trigger Build (Recommendation, Rank or FBT)
...
###<a name="114-get-builds-status-of-a-model"></a>11.4. Get Builds Status of a Model
...
###<a name="115-get-builds-status"></a>11.5. Get Builds Status
...
###<a name="116-delete-build"></a>11.6. Delete Build
Deletes a build.
...
###<a name="117-cancel-build"></a>11.7. Cancel Build
...
###<a name="118-get-build-parameters"></a>11.8. Get Build Parameters
...
##<a name="12-recommendation"></a>12. Recommendation
###<a name="121-get-item-recommendations-for-active-build"></a>12.1. Get Item Recommendations (for active build)
...
###<a name="122-get-item-recommendations-of-a-specific-build"></a>12.2. Get Item Recommendations (of a specific build)
...
###<a name="123-get-fbt-recommendations-for-active-build"></a>12.3. Get FBT Recommendations (for active build)
...
###<a name="124-get-fbt-recommendations-of-a-specific-build"></a>12.4. Get FBT Recommendations (of a specific build)
...
###<a name="125-get-user-recommendations-for-active-build"></a>12.5. Get User Recommendations (for active build)
...
###<a name="126-get-user-recommendations-with-item-list-for-active-build"></a>12.6. Get User Recommendations with item list (for active build)
...
###<a name="127-get-user-recommendations--of-a-specific-build"></a>12.7. Get User Recommendations  (of a specific build)
...
###<a name="128-get-user-recommendations-with-item-list-of-a-specific-build"></a>12.8. Get User Recommendations with item list (of a specific build)
...
##<a name="13-user-usage-history"></a>13. User Usage History
...
###<a name="131-retrieve-user-history"></a>13.1 Retrieve user history
...
###<a name="141-get-notifications"></a>14.1. Get Notifications
...
###<a name="142-delete-model-notifications"></a>14.2. Delete Model Notifications
...
###<a name="143-delete-user-notifications"></a>14.3. Delete User Notifications
