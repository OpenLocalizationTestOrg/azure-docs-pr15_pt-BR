...
Este tutorial ajuda você a implantar um aplicativo de web HTML + CSS simple para [O serviço de aplicativo do Azure](../app-service/app-service-value-prop-what-is.md).
...
- Implante HTML e CSS a ele.
- Consulte as páginas em execução ao vivo em produção.
- Atualize o seu conteúdo da mesma forma que faria [push que gito confirma](https://git-scm.com/docs/git-push).
...
## <a name="deploy-a-simple-html-site"></a>Implantar um site simple do HTML
